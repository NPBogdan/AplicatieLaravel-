                    ...
                    <div class="p-6 bg-white border-b border-gray-200">
                        ...
                        <form method="post" action="/tools">
                            ...
                            <div class="mb-3">
                                ...
                                <input required type="text" class="form-control" id="object" name="tool">
                            </div>
                        ...
                        @if($userObjects->count() > 0)
                            <form method="POST" action="/attributes">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input required type="text" class="form-control" id="representative_name" name="representative_name" >
                                </div>
                                <div class="mb-3">
                                    <label for="nr_telephone_representative" class="form-label">Representative phone number</label>
                                    <input required type="text" class="form-control" id="nr_telephone_representative" name="nr_telephone_representative" >
                                </div>
                                <div class="mb-3">
                                    <label for="validity_start_date" class="form-label">Validity Start Date</label>
                                    <input required type="date" class="form-control" id="validity_start_date" name="validity_start_date" >
                                </div>
                                <div class="mb-3">
                                    <label for="expiration_date" class="form-label">Expiration Date</label>
                                    <input required type="date" class="form-control" id="expiration_date" name="expiration_date">
                                </div>
